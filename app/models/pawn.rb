  ...
  def valid_move?(new_row, new_column)
    ...
    if color == "white"
      ...
      if moves == 0
        ...
        return true if new_row == position_row - 2  && new_column == position_column && @two_ahead == nil
      end
      ...
      return true if new_row == position_row - 1 && new_column = position_column && @one_ahead == nil
